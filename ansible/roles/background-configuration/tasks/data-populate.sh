...
export masternode=172.26.133.148
export user=admin
...
{
  curl -X POST "http://${user}:${password}@${masternode}:5984/geo_origin " --header "Content-Type: application/json" --data @/home/ubuntu/90024/Backend/MyCouchdb/geo_melb/origin_melb.json
}&> /dev/null
echo "=============Done==================="
echo "  "
