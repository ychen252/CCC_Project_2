...
var locate_data = $.ajax({
    url: "http://172.26.133.148:5984/geo_origin/geo_melb",
...
var json_mel = (function() {
    ...
    $.ajax({
        async: false,
        url: "http://172.26.133.148:5984/food_twitters/_design/designs/_view/agg_by_region?group=true",
        dataType: "json",
...
$.when(locate_data,json_mel).done(function() {
    ...
    L.tileLayer('https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.png?access_token=pk.eyJ1IjoibWFwYm94IiwiYSI6ImNpejY4NXVycTA2emYycXBndHRqcmZ3N3gifQ.rJcFIG214AriISLbB6B5aw', {
        ...
        info.update = function (properties) {
          this._div.innerHTML = '<h4>Food Data</h4>' +  (properties ?
